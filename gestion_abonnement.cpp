...
#include "ui_gestion_abonnement.h"
...
//1
gestion_abonnement::gestion_abonnement(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::gestion_abonnement)
{
    ui->setupUi(this);
...
gestion_abonnement::~gestion_abonnement()
{
    delete ui;
}


void gestion_abonnement::on_AJOUTER_2_clicked()
{
...
void gestion_abonnement::on_supp_clicked()
{
...
int mode =1;
void gestion_abonnement::on_checkBox_2_clicked()
{
    if(mode==1)
    {
...
void gestion_abonnement::on_supp_2_clicked()
{
        int ID_A=ui->id_a->text().toInt();
        int nb_mois=ui->nb_mois->currentIndex();
...
void gestion_abonnement::on_supp_3_clicked()
{
    abonnement a;
        QString text;
...
void gestion_abonnement::on_supp_6_clicked()
{
    QMessageBox::information(nullptr, QObject::tr("Ok"),
...
void gestion_abonnement::on_supp_5_clicked()
{
    QMessageBox::information(nullptr, QObject::tr("Ok"),
             QObject::tr("tri effectué.\n"
                         "Click Cancel to exit."), QMessageBox::Cancel);
...
void gestion_abonnement::on_supp_8_clicked()
{
    Dialog_stats stats;
    stats.setModal(true);
    stats.exec();
...
void gestion_abonnement::on_supp_9_clicked()
{
...
void gestion_abonnement::on_pushButton_2_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}

void gestion_abonnement::on_pushButton_9_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void gestion_abonnement::on_pushButton_8_clicked()
{
...
void gestion_abonnement::on_pushButton_valid_2_clicked()
{
...
void gestion_abonnement::on_AJOUTER_3_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
    ui->label->setText("");
}

void gestion_abonnement::on_motdepasseoublier_clicked()
{
    ui->stackedWidget->setCurrentIndex(3);
}

void gestion_abonnement::on_retouroublier_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
...
void gestion_abonnement::on_AJOUTER_4_clicked()
{
...
void gestion_abonnement::on_retouroublier_2_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
    ui->lineEdit_email_3->setText("");
    ui->new_2->setText("");
...
void gestion_abonnement::on_confnouv_clicked()
{
...
void gestion_abonnement::on_checkBox_3_clicked()
{
    if(mode==1)
    {
...
void gestion_abonnement::on_supp_7_clicked()
{
    a.write_to_arduino("1");
}
void gestion_abonnement::update_label()
{
...
void gestion_abonnement::on_AJOUTER_5_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}

void gestion_abonnement::on_retouroublier_3_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
}
